                    ...
                    <div class="p-5 rounded-2xl bg-slate-50/80 border border-slate-200/80 space-y-4">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                            <div>
                                ...
                                {{-- Auto-applied ones are labelled. A candidate must be able to
                                     tell at a glance which applications they sent and which we
                                     sent for them, or the withdraw button is a trap. --}}
                                @if ($application->source === 'Auto Apply')
                                    <span class="inline-flex items-center px-2 py-0.5 mt-1.5 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-emerald-50 text-emerald-700 border border-emerald-200">Sent by auto-apply</span>
                                @endif
                            </div>
                            <div class="flex items-center gap-2">
