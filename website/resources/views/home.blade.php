...
<script>
    ...
    <section class="relative flex flex-col"
        ...
        <div class="container mx-auto px-6 max-w-4xl flex-1 flex flex-col justify-center text-center py-10">
            ...
            <h1 class="lb-enter lb-d1 font-heading font-bold tracking-tight leading-[1.08] mb-9 text-[30px] sm:text-[42px] lg:text-[50px]"
                style="color:#031F49;">
            ...
            <div class="lb-enter lb-d5 mt-2">
                <p class="text-[11px] font-bold uppercase tracking-[0.14em] mb-1" style="color:var(--color-text-muted);">
                    Hiring now for
                </p>
