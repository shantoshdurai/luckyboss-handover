        ...
        <form method="POST" action="{{ route('admin.job-matching.update') }}" class="space-y-6">
            ...
            <div class="rounded-2xl p-6 sm:p-8 border border-amber-200 shadow-sm bg-amber-50">
                <div class="flex items-center justify-between gap-3 pb-4 mb-6 border-b border-amber-200">
                    ...
                    <span class="shrink-0 inline-flex items-center px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-emerald-50 text-emerald-700 border border-emerald-200">Live</span>
                </div>
                ...
                <label class="flex items-start gap-3 cursor-pointer group">
                    ...
                    <span>
                        ...
                        <span class="block text-[11px] text-text-muted mt-0.5 leading-relaxed">
                            Turning this on lets the nightly <span class="font-mono">auto-apply:run</span> job send applications for candidates who have <span class="font-semibold text-navy">also opted in themselves</span> on their own Auto Apply page &mdash; this switch is a master control, never consent on anyone&rsquo;s behalf. Each candidate sets their own match floor and daily cap, every run is logged for them, and we only ever apply to Lucky Boss vacancies. Watch one run first with <span class="font-mono">php artisan auto-apply:run --dry</span>.
                        </span>
                    </span>
                </label>
            </div>
